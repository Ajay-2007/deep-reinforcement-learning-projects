...
if __name__ == "__main__":
    ...
    parser.add_argument("--show_genres", action='store_true', default=False, help="Display genres stats")
    parser.add_argument("--show_dials", action='store_true', default=False, help="Display dialogs")
    parser.add_argument("--show_train", action='store_true', default=False, help="Display training pairs")
    parser.add_argument("--show_dict_freq", action='store_true', default=False, help="Display dictionary frequency")
