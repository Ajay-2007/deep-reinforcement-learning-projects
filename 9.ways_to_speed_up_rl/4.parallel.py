...
if __name__ == "__main__":
    ...
    fps_handler = ptan_ignite.EpisodeFPSHandler()
    batch_generator = BatchGenerator(buffer, exp_queue, fps_handler, params.replay_initial, batch_size=params.batch_size)
    ...
    def episode_completed(trainer: Engine):
        print('Epsiode %d: reward=%s, steps=%s, speed=%.3f frames/s, elapsed=%s' % (
            trainer.state.episode, trainer.state.episode_rewards,
