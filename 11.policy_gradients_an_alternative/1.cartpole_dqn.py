...
if __name__ == "__main__":
    ...
    replay_buffer = ptan.experience.ExperienceReplayBuffer(exp_source, buffer_size=REPLAY_BUFFER)
    ...
    while True:
        ...
        if new_rewards:
            ...
            if mean_rewards > 195:
                print("Solved in %d steps and %d episdoes" % (step_idx, done_episodes))
                break
